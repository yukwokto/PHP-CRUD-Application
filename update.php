...
if (isset($_POST["id"]) && !empty($_POST["id"])) {
    ...
    $id = $_POST["id"];
    $previousFileName = $_POST["oldName"];
    ...
    if (isset($_FILES['image'])) {
        ...
        //file upload
        if (empty($imageFileName_err) && isset($_FILES['image']) && empty($speciesName_err) && empty($age_err) && empty($importDate_err) && empty($imageFileName_err)) {
    ...
    if (empty($speciesName_err) && empty($age_err) && empty($importDate_err) && empty($imageFileName_err)) {
        ...
        $animal = new Animal($id, $speciesName, $age, $importDate, $imageFileName);
        $updateResult = $animalDAO->updateAnimal($animal);
    ...
    if (isset($_GET["id"]) && !empty(trim($_GET["id"]))) {
        ...
        if ($animal) {
            ...
            $oldName = $animal->getImageFileName();
        } else {
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <p>Please edit the input values and submit to update the animal record.</p>
